...
public class Instance extends TimerTask {
    ...
    public void run(){
        try{
            System.out.println("正在向"+Global.globalSetting.apiUrl+"发起连接，deviceId="+deviceId);
            JSONObject obj = RESTful.Restful(Global.globalSetting.apiUrl, "deviceId="+deviceId);
            ...
            List<Tag> tags = Tag.toTagList(deviceId,obj.getJSONArray("tags"));
